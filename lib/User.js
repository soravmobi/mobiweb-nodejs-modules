                        ...
                        connection.query(user_device_select_query, function(err, result) {
                            ...
                            connection.query(user_device_query, function(err, result) {
                                ...
                                connection.commit(function(err) {
                                    ...
                                    let user_response  = {};
                                    user_response.userEmail = custom.nullChecker(results[0].userEmail);
                                    user_response.userType  = custom.nullChecker(results[0].userType);
                                    user_response.masterUserId  = parseInt(results[0].masterUserId);
                                    user_response.userFirstName = custom.nullChecker(detail_results[0].userFirstName);
                                    user_response.userLastName  = custom.nullChecker(detail_results[0].userLastName);
                                    user_response.userLoginSessionKey  = custom.nullChecker(detail_results[0].userLoginSessionKey);
                                    res.send({
                                        "code": 200,
