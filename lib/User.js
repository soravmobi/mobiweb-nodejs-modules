                    ...
                    if(err){
                        ...
                        if(results != ''){
                            ...
                            res.send({
                                ...
                                "response": {},
                                "status": 0,
                                "message": 'Invalid user login session key'
                            });
                        }
                    }
                });
                            ...
                            if(results[0].userId == code_results[0].userId){
                                if(code_results[0].userEmailVerified == 1){
                                    ...
                                    res.send({
                                        ...
                                        "response": {},
                                        "status": 0,
                                        "message": 'Your account has been blocked, please contact to our support team.'
                                    }); 
                                    return false;
                                }else{
                                ...
                                res.send({
                                    ...
                                    "response": {},
                                    "status": 0,
                                    "message": 'Invalid user verification code Or mismatch with user account.'
                                }); 
                            }
                        }else{
                            res.send({
                ...
                model.getAllWhere(function(err,resp){
                    if(err){
                        ...
                        if(resp != ""){
                                ...
                                model.getAllWhere(function(err,main_results){
                                    if(err){
                                        ...
                                        if(main_results != ""){
                                            ...
                                            res.send({"code" : '200', "response" : {},"status" : '0',"message" : 'User details not found.'});
                                            return false;
                                        }
                                    }
                            ...
                            res.send({"code" : '200', "response" : {},"status" : '0',"message" : 'Invalid login session key'});
                            return false;
                        }
                    }
